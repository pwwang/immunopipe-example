#args <- c("/research/bsi/projects/adhoc/s304818.Single-cell-TCR-RNA-seq/immunopipe-example/output/VJUsage/2/LN3.fancyvj.wt.txt", "/research/bsi/projects/adhoc/s304818.Single-cell-TCR-RNA-seq/immunopipe-example/output/VJUsage/2/LN3.fancyvj.wt.png")
