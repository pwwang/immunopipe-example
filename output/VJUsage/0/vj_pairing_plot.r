#args <- c("/research/bsi/projects/adhoc/s304818.Single-cell-TCR-RNA-seq/immunopipe-example/output/VJUsage/0/LN1.fancyvj.wt.txt", "/research/bsi/projects/adhoc/s304818.Single-cell-TCR-RNA-seq/immunopipe-example/output/VJUsage/0/LN1.fancyvj.wt.png")
